# Veltrixa AI Document Classification Service
...
The project covers the development of practical GDPR, GRC, and ISO/IEC 27001 documentation for the fictional Veltrixa platform.

The portfolio currently includes documentation related to data flow analysis, Privacy by Design, DPIA screening, an ISO/IEC 27001 Information Security Management System (ISMS), and vendor security assessment. Additional GDPR governance documentation, including a Record of Processing Activities (ROPA), will be added as the project progresses.
